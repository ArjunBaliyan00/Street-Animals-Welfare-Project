    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='donate_screenshot/Screenshot_5.png', null=True, upload_to='donate_screenshot/')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('animal_type', models.CharField(choices=[('Dog', 'Dog'), ('Cat', 'Cat'), ('Cow', 'Cow'), ('Other', 'Other')], default='Dog', max_length=10)),
                ...
                ('collar_belt_number', models.CharField(blank=True, max_length=50, null=True)),
